 ...
 * @param content     分片正文（截断预览，供前端召回抽屉展示；不可为 null，空片段传空串）
 */
public record RetrievalSource(String chunkId, String docTitle, String headingPath, double score, String content) {}
